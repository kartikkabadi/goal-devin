#!/usr/bin/env python3
"""Candidate fixture that creates a broken symlink inside the runtime directory."""
...
def main() -> int:
    ...
    if supervisor.runtime_dir is not None and supervisor.runtime_dir.exists():
        (supervisor.runtime_dir / "broken-link").symlink_to("/this/does/not/exist/anywhere")
    return rc
