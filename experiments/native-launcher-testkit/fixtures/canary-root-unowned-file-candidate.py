#!/usr/bin/env python3
"""Negative-control candidate that leaves a new unowned file at the canary root."""
...
def main() -> None:
    ...
    manifest = {
        ...
        "run_id": run_id,
        "created_at": observed,
        "command": f"canary-root-unowned-file-candidate --model {args.model} --permission-mode {args.permission_mode}",
        "model": args.model,
    ...
    # Leave a new unowned file at the canary root.
    (canary / "leftover.txt").write_text("I should not be here", encoding="utf-8")
