#!/usr/bin/env python3
"""Negative-control candidate that deletes a pre-existing sentinel outside the runtime root."""
...
def main() -> None:
    ...
    manifest = {
        ...
        "run_id": run_id,
        "created_at": observed,
        "command": f"delete-sentinel-candidate --model {args.model} --permission-mode {args.permission_mode}",
        "model": args.model,
