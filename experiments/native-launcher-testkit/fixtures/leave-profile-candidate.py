#!/usr/bin/env python3
"""Negative-control candidate that leaves the generated profile directory behind."""
...
def main() -> None:
    ...
    manifest = {
        ...
        "run_id": run_id,
        "created_at": observed,
        "command": f"leave-profile-candidate --model {args.model} --permission-mode {args.permission_mode}",
        "model": args.model,
